...
/*
    ...
    Cmdline: sokol-shdc -i deps/default.glsl -o deps/default.glsl.h -l glsl330:metal_macos:hlsl5:wgpu -b
...
*/
static const char vs_source_glsl330[478] = {
...
*/
static const char fs_source_glsl330[172] = {
    0x23,0x76,0x65,0x72,0x73,0x69,0x6f,0x6e,0x20,0x33,0x33,0x30,0x0a,0x0a,0x75,0x6e,
...
/*
    ...
    void vert_main()
    {
        ...
        gl_PointSize = psize;
        uv = mul(float4(texcoord0, 0.0f, 1.0f), _21_tm);
        color = color0;
    }
...
*/
static const char vs_source_hlsl5[1151] = {
    ...
    0x2c,0x20,0x5f,0x32,0x31,0x5f,0x74,0x6d,0x29,0x3b,0x0a,0x20,0x20,0x20,0x20,0x63,
...
/*
    ...
    void frag_main()
    {
        frag_color = tex.Sample(_tex_sampler, uv.xy) * color;
    }
...
*/
static const char fs_source_hlsl5[620] = {
    ...
    0x65,0x78,0x5f,0x73,0x61,0x6d,0x70,0x6c,0x65,0x72,0x2c,0x20,0x75,0x76,0x2e,0x78,
    0x79,0x29,0x20,0x2a,0x20,0x63,0x6f,0x6c,0x6f,0x72,0x3b,0x0a,0x7d,0x0a,0x0a,0x53,
...
/*
    ...
    vertex main0_out main0(main0_in in [[stage_in]], constant vs_params& _21 [[buffer(0)]])
    {
        ...
        out.uv = _21.tm * float4(in.texcoord0, 0.0, 1.0);
        out.color = in.color0;
        return out;
    }
    
*/
static const uint8_t vs_bytecode_metal_macos[3317] = {
    ...
    0x01,0x00,0x00,0x48,0x41,0x53,0x48,0x20,0x00,0x5c,0x46,0x14,0xd0,0x34,0x83,0xd9,
    0xb7,0x2b,0xb3,0x76,0x9e,0x88,0x98,0xb4,0x61,0xaa,0xa5,0x36,0xc2,0x26,0x42,0x6f,
    0x51,0xea,0x8f,0xd9,0x13,0xdc,0x50,0xbe,0xe1,0x4f,0x46,0x46,0x54,0x18,0x00,0x00,
    ...
    0xbe,0x64,0x62,0x86,0x90,0xc1,0x52,0x28,0x6d,0xa0,0xb8,0xc1,0x72,0x28,0x62,0xb0,
...
/*
    ...
    {
        main0_out out = {};
        out.frag_color = tex.sample(texSmplr, in.uv.xy) * in.color;
        return out;
    }
    
*/
static const uint8_t fs_bytecode_metal_macos[2825] = {
    0x4d,0x54,0x4c,0x42,0x01,0x80,0x02,0x00,0x02,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
    ...
    0x4e,0x41,0x4d,0x45,0x06,0x00,0x6d,0x61,0x69,0x6e,0x30,0x00,0x54,0x59,0x50,0x45,
    0x01,0x00,0x01,0x48,0x41,0x53,0x48,0x20,0x00,0x88,0x47,0x8a,0xe6,0x52,0x04,0xac,
    0x1b,0x38,0x3e,0x55,0x03,0xef,0xe8,0xca,0x34,0x4f,0xff,0xee,0x43,0x34,0x5c,0x58,
    0x6c,0x64,0x94,0xab,0xf3,0xf1,0xaa,0x69,0xec,0x4f,0x46,0x46,0x54,0x18,0x00,0x00,
    0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
    0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x56,0x45,0x52,0x53,0x08,0x00,0x01,0x00,0x08,
    ...
    0x2c,0xa1,0x09,0x00,0x00,0x79,0x18,0x00,0x00,0xb8,0x00,0x00,0x00,0x1a,0x03,0x4c,
    ...
    ,
...
/*
    ...
    void main()
    {
        ...
        gl_PointSize = psize;
        uv = _21.tm * vec4(texcoord0, 0.0, 1.0);
        color = color0;
    }
    
*/
static const uint8_t vs_bytecode_wgpu[1992] = {
    0x03,0x02,0x23,0x07,0x00,0x00,0x01,0x00,0x0b,0x00,0x08,0x00,0x35,0x00,0x00,0x00,
    ...
    0x07,0x00,0x00,0x00,0x64,0x65,0x70,0x73,0x2f,0x64,0x65,0x66,0x61,0x75,0x6c,0x74,
    0x2e,0x67,0x6c,0x73,0x6c,0x00,0x00,0x00,0x03,0x00,0x37,0x00,0x02,0x00,0x00,0x00,
    ...
    ,
    ...
    0x47,0x00,0x04,0x00,0x21,0x00,0x00,0x00,0x1e,0x00,0x00,0x00,0x03,0x00,0x00,0x00,
    0x47,0x00,0x04,0x00,0x25,0x00,0x00,0x00,0x1e,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
    0x47,0x00,0x04,0x00,0x2a,0x00,0x00,0x00,0x1e,0x00,0x00,0x00,0x01,0x00,0x00,0x00,
    0x47,0x00,0x04,0x00,0x32,0x00,0x00,0x00,0x1e,0x00,0x00,0x00,0x01,0x00,0x00,0x00,
    ...
    ,
    ...
    ,
...
*/
static const uint8_t fs_bytecode_wgpu[960] = {
    ...
    0x64,0x65,0x70,0x73,0x2f,0x64,0x65,0x66,0x61,0x75,0x6c,0x74,0x2e,0x67,0x6c,0x73,
    ...
    0x6f,0x72,0x00,0x00,0x05,0x00,0x03,0x00,0x0f,0x00,0x00,0x00,0x74,0x65,0x78,0x00,
    0x05,0x00,0x03,0x00,0x12,0x00,0x00,0x00,0x75,0x76,0x00,0x00,0x05,0x00,0x04,0x00,
    0x17,0x00,0x00,0x00,0x63,0x6f,0x6c,0x6f,0x72,0x00,0x00,0x00,0x47,0x00,0x04,0x00,
    ...
    0x17,0x00,0x00,0x00,0x1e,0x00,0x00,0x00,0x01,0x00,0x00,0x00,0x13,0x00,0x02,0x00,
    ...
    0x11,0x00,0x00,0x00,0x01,0x00,0x00,0x00,0x09,0x00,0x00,0x00,0x3b,0x00,0x04,0x00,
    0x11,0x00,0x00,0x00,0x12,0x00,0x00,0x00,0x01,0x00,0x00,0x00,0x17,0x00,0x04,0x00,
    0x13,0x00,0x00,0x00,0x08,0x00,0x00,0x00,0x02,0x00,0x00,0x00,0x3b,0x00,0x04,0x00,
    0x11,0x00,0x00,0x00,0x17,0x00,0x00,0x00,0x01,0x00,0x00,0x00,0x08,0x00,0x04,0x00,
    0x07,0x00,0x00,0x00,0x09,0x00,0x00,0x00,0x0b,0x00,0x00,0x00,0x36,0x00,0x05,0x00,
    ...
    ,
...
static inline const sg_shader_desc* sim_shader_desc(sg_backend backend) {
  ...
  if (backend == SG_BACKEND_WGPU) {
    ...
    if (!valid) {
      ...
      desc.vs.bytecode.size = 1992;
      desc.vs.entry = "main";
      desc.vs.uniform_blocks[0].size = 128;
      desc.vs.uniform_blocks[0].layout = SG_UNIFORMLAYOUT_STD140;
      desc.fs.bytecode.ptr = fs_bytecode_wgpu;
      desc.fs.bytecode.size = 960;
      desc.fs.entry = "main";
      desc.fs.images[0].name = "tex";
      desc.fs.images[0].image_type = SG_IMAGETYPE_2D;
      desc.fs.images[0].sampler_type = SG_SAMPLERTYPE_FLOAT;
